...
const RenderTabIsOnsale = ({
  isOnSale,
  setIsIsOnSale,
}: RenderTabIsOnsaleProps) => {
  return (
    <div
      className={`flex items-center justify-center px-4 py-2 text-sm font-medium rounded-full border-2 focus:outline-none cursor-pointer select-none ${
        isOnSale
...
export default RenderTabIsOnsale;
