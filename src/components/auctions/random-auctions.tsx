  ...
  return (
    <>
      ...
      {auctions?.length
            ...
            return (
              <div key={index} className="flex flex-col gap-1">
                <Link
                  ...
                  className="font-bold text-base text-grey-c900 hover:cursor-pointer hover:underline hover:text-primary-c900"
                >
                  {auction?.name}
                </Link>
        ...
        : null}
      {!auctions?.length ? (
        <div className="text-center font-medium text-grey-c900 text-sm">
          Không có dự án nào!
        </div>
      ) : null}
    </>
