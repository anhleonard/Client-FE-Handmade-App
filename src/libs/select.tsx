    ...
    return select.length > 0 ? (
      multiple ? (
        ...
        >
          <div
            className={`truncate ${
              error ? "font-medium text-support-c500" : ""
            }`}
          >
            {select[0].label}
          </div>
            ...
            <div className="relative flex w-[inherit] truncate">
              {altLabel ? (
                ...
                <div
                  ...
                  } z-10 flex w-full flex-row items-center gap-3 truncate`}
                >
              ...
              {filter && (
                <input
                  ...
                  className={`absolute w-full text-grey-c700 ${
                    !open ? "opacity-0" : "z-50 opacity-100"
                  } truncate bg-[inherit] outline-0`}
                />
              )}
            </div>
            {!open ? (
                ...
                className={`
                                        ...
                                        ${
                                          select.find(
                                            ...
                                            ? `bg-primary-c200 hover:bg-primary-c200`
